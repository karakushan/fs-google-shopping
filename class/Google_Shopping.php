...
class Google_Shopping
{
    ...
    {
        // Додаємо окрему вкладку Google Shopping
        $tabs['google_shopping'] = [
            'title' => __('Google Shopping', 'fs-google-shopping'),
            'fields' => [
                'fs_gs_product_condition' => [
                ...
                'fs_gs_exclude_from_feed' => [
                    'label' => __('Exclude from export file', 'fs-google-shopping'),
                    'type' => 'checkbox',
                    'help' => __('If checked, this product will be excluded from Google Shopping feed', 'fs-google-shopping'),
                ],
            ],
        ];
